...
sudo zpool create sabrent -f \
     mirror /dev/by-id/usb-SABRENT_DISK00_DB98765432146-0:0 \
            /dev/by-id/usb-SABRENT_DISK00_DB98765432146-0:1 \
     mirror /dev/by-id/usb-SABRENT_DISK00_DB98765432146-0:2 \
            /dev/by-id/usb-SABRENT_DISK00_DB98765432146-0:3
...
sudo zfs set compression=on sabrent
